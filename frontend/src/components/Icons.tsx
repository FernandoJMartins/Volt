...
/** Selo de plataforma — glifos genericos proprios (sem logo de terceiro). */
export const IconPlatformX = ({ size = 14, className }: P) => (
  <svg {...base(size)} className={className}>
    <path d="M5 4 19 19M19 4 5 19" stroke="currentColor" strokeWidth={2.6} strokeLinecap="round" fill="none" />
  </svg>
)

export const IconPlatformThreads = ({ size = 14, className }: P) => (
  <svg {...base(size)} className={className}>
    <path
      d="M12 3.5c-4.7 0-7.5 2.9-7.5 8.5s2.8 8.5 7.5 8.5c3.6 0 6-1.7 6.7-4.6.5-2.2-.4-4-2.7-4.7-.3-2.3-1.8-3.6-4.1-3.6-1.8 0-3.2.9-3.9 2.4l1.8.8c.4-.8 1.1-1.3 2.1-1.3 1.1 0 1.8.6 2 1.7-2.7.1-4.9 1.1-4.9 3.5 0 1.8 1.5 3 3.6 3 1.9 0 3.2-.9 3.7-2.5.1.7 0 1.6-.2 2-.6 1.6-2.2 2.4-4.6 2.4-3.5 0-5.5-2.1-5.5-6.5s2-6.5 5.5-6.5c2.6 0 4.2 1 5 2.9l1.9-.8c-1.1-2.5-3.4-4.2-6.9-4.2Zm.3 9.1c1 0 1.9.3 2.5.7-.2 1.4-1 2.1-2.3 2.1-1 0-1.7-.5-1.7-1.3 0-1 1-1.5 2.5-1.5Z"
    />
  </svg>
)
